...
const Schema: z.ZodType<Prisma.ItemStatsUpdateManyWithoutUserNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => ItemStatsUpdateManyWithWhereWithoutUserInputObjectSchema),
        z
          .lazy(() => ItemStatsUpdateManyWithWhereWithoutUserInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const ItemStatsUpdateManyWithoutUserNestedInputObjectSchema = Schema;
