...
const Schema: z.ZodType<Prisma.ItemStatsUncheckedUpdateManyWithoutItemNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => ItemStatsUpdateManyWithWhereWithoutItemInputObjectSchema,
          ),
          z
            .lazy(
              () => ItemStatsUpdateManyWithWhereWithoutItemInputObjectSchema,
...
export const ItemStatsUncheckedUpdateManyWithoutItemNestedInputObjectSchema =
  Schema;
