...
exports.UserUncheckedCreateWithoutLogInputObjectSchema = void 0;
/* eslint-disable */
...
exports.UserUncheckedCreateWithoutLogInputObjectSchema = zod_1.z.object({
    id: zod_1.z.string().optional(), name: zod_1.z.union([zod_1.z.string(),
        ...
        zod_1.z.null()]).optional().nullable(), accounts: zod_1.z.lazy(() => AccountUncheckedCreateNestedManyWithoutUserInput_schema_1.AccountUncheckedCreateNestedManyWithoutUserInputObjectSchema).optional(), sessions: zod_1.z.lazy(() => SessionUncheckedCreateNestedManyWithoutUserInput_schema_1.SessionUncheckedCreateNestedManyWithoutUserInputObjectSchema).optional(), itemStats: zod_1.z.lazy(() => ItemStatsUncheckedCreateNestedManyWithoutUserInput_schema_1.ItemStatsUncheckedCreateNestedManyWithoutUserInputObjectSchema).optional()
}).strict();
