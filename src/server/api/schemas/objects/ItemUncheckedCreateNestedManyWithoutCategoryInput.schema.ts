...
const Schema: z.ZodType<Prisma.ItemUncheckedCreateNestedManyWithoutCategoryInput> =
  z
    .object({
      create: z
        .union([
...
export const ItemUncheckedCreateNestedManyWithoutCategoryInputObjectSchema =
  Schema;
