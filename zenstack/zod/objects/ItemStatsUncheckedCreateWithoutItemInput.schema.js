...
exports.ItemStatsUncheckedCreateWithoutItemInputObjectSchema = void 0;
/* eslint-disable */
const zod_1 = require("zod");
exports.ItemStatsUncheckedCreateWithoutItemInputObjectSchema = zod_1.z.object({
    id: zod_1.z.number().optional(), userId: zod_1.z.string(), releaseId: zod_1.z.union([zod_1.z.number(),
        zod_1.z.null()]).optional().nullable(), timestamp: zod_1.z.union([zod_1.z.date().optional(), zod_1.z.string().datetime().optional()]), description: zod_1.z.union([zod_1.z.string(),
