...
const Schema: z.ZodType<Prisma.SynergyItemUncheckedCreateNestedManyWithoutItemInput> =
  z
    .object({
      create: z
        .union([
...
export const SynergyItemUncheckedCreateNestedManyWithoutItemInputObjectSchema =
  Schema;
