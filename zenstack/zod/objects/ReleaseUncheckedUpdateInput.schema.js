...
exports.ReleaseUncheckedUpdateInputObjectSchema = void 0;
/* eslint-disable */
...
const ItemStatsUncheckedUpdateManyWithoutReleaseNestedInput_schema_1 = require("./ItemStatsUncheckedUpdateManyWithoutReleaseNestedInput.schema");
const RecipeUncheckedUpdateManyWithoutReleaseNestedInput_schema_1 = require("./RecipeUncheckedUpdateManyWithoutReleaseNestedInput.schema");
const PackUncheckedUpdateManyWithoutReleaseNestedInput_schema_1 = require("./PackUncheckedUpdateManyWithoutReleaseNestedInput.schema");
exports.ReleaseUncheckedUpdateInputObjectSchema = zod_1.z.object({
    id: zod_1.z.union([zod_1.z.number(),
        ...
        zod_1.z.lazy(() => BoolFieldUpdateOperationsInput_schema_1.BoolFieldUpdateOperationsInputObjectSchema)]).optional(), itemStats: zod_1.z.lazy(() => ItemStatsUncheckedUpdateManyWithoutReleaseNestedInput_schema_1.ItemStatsUncheckedUpdateManyWithoutReleaseNestedInputObjectSchema).optional(), recipes: zod_1.z.lazy(() => RecipeUncheckedUpdateManyWithoutReleaseNestedInput_schema_1.RecipeUncheckedUpdateManyWithoutReleaseNestedInputObjectSchema).optional(), packs: zod_1.z.lazy(() => PackUncheckedUpdateManyWithoutReleaseNestedInput_schema_1.PackUncheckedUpdateManyWithoutReleaseNestedInputObjectSchema).optional()
}).strict();
