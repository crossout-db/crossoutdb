...
const Schema: z.ZodType<Prisma.ItemUncheckedCreateNestedManyWithoutFactionInput> =
  z
    .object({
      create: z
        .union([
...
export const ItemUncheckedCreateNestedManyWithoutFactionInputObjectSchema =
  Schema;
