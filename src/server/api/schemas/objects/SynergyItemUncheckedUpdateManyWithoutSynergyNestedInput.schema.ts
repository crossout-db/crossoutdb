...
const Schema: z.ZodType<Prisma.SynergyItemUncheckedUpdateManyWithoutSynergyNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const SynergyItemUncheckedUpdateManyWithoutSynergyNestedInputObjectSchema =
  Schema;
