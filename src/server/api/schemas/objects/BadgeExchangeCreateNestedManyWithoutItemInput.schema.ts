...
const Schema: z.ZodType<Prisma.BadgeExchangeCreateNestedManyWithoutItemInput> =
  z
    .object({
      create: z
        .union([
...
export const BadgeExchangeCreateNestedManyWithoutItemInputObjectSchema = Schema;
