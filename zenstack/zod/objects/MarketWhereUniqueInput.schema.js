...
exports.MarketWhereUniqueInputObjectSchema = void 0;
/* eslint-disable */
...
exports.MarketWhereUniqueInputObjectSchema = zod_1.z.object({
    id: zod_1.z.number().optional(), AND: zod_1.z.union([zod_1.z.lazy(() => MarketWhereInput_schema_1.MarketWhereInputObjectSchema),
        zod_1.z.lazy(() => MarketWhereInput_schema_1.MarketWhereInputObjectSchema).array()]).optional(), OR: zod_1.z.lazy(() => MarketWhereInput_schema_1.MarketWhereInputObjectSchema).array().optional(), NOT: zod_1.z.union([zod_1.z.lazy(() => MarketWhereInput_schema_1.MarketWhereInputObjectSchema),
        zod_1.z.lazy(() => MarketWhereInput_schema_1.MarketWhereInputObjectSchema).array()]).optional(), itemId: zod_1.z.union([zod_1.z.lazy(() => IntFilter_schema_1.IntFilterObjectSchema),
