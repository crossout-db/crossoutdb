...
const Schema: z.ZodType<Prisma.ItemUncheckedUpdateWithoutItemSynergiesInput> = z
  .object({
    id: z
      .union([
        z.number(),
...
export const ItemUncheckedUpdateWithoutItemSynergiesInputObjectSchema = Schema;
