...
const Schema: z.ZodType<Prisma.RecipeUncheckedUpdateManyWithoutReleaseNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => RecipeUpdateManyWithWhereWithoutReleaseInputObjectSchema,
          ),
          z
            .lazy(
              () => RecipeUpdateManyWithWhereWithoutReleaseInputObjectSchema,
...
export const RecipeUncheckedUpdateManyWithoutReleaseNestedInputObjectSchema =
  Schema;
