...
const Schema: z.ZodType<Prisma.SynergyItemUpdateManyWithoutItemNestedInput> = z
  .object({
    create: z
      .union([
...
export const SynergyItemUpdateManyWithoutItemNestedInputObjectSchema = Schema;
