...
const Schema: z.ZodType<Prisma.logUncheckedUpdateManyWithoutUserNestedInput> = z
  .object({
    create: z
      .union([
...
export const logUncheckedUpdateManyWithoutUserNestedInputObjectSchema = Schema;
