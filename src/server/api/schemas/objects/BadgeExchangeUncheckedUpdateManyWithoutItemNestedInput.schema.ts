...
const Schema: z.ZodType<Prisma.BadgeExchangeUncheckedUpdateManyWithoutItemNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BadgeExchangeUncheckedUpdateManyWithoutItemNestedInputObjectSchema =
  Schema;
