...
const Schema: z.ZodType<Prisma.ItemStatsUncheckedUpdateWithoutReleaseInput> = z
  .object({
    id: z
      .union([
        z.number(),
...
export const ItemStatsUncheckedUpdateWithoutReleaseInputObjectSchema = Schema;
