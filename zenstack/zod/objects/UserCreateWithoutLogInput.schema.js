...
exports.UserCreateWithoutLogInputObjectSchema = void 0;
/* eslint-disable */
...
exports.UserCreateWithoutLogInputObjectSchema = zod_1.z.object({
    id: zod_1.z.string().optional(), name: zod_1.z.union([zod_1.z.string(),
        ...
        zod_1.z.null()]).optional().nullable(), accounts: zod_1.z.lazy(() => AccountCreateNestedManyWithoutUserInput_schema_1.AccountCreateNestedManyWithoutUserInputObjectSchema).optional(), sessions: zod_1.z.lazy(() => SessionCreateNestedManyWithoutUserInput_schema_1.SessionCreateNestedManyWithoutUserInputObjectSchema).optional(), itemStats: zod_1.z.lazy(() => ItemStatsCreateNestedManyWithoutUserInput_schema_1.ItemStatsCreateNestedManyWithoutUserInputObjectSchema).optional()
}).strict();
