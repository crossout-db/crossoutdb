...
const Schema: z.ZodType<Prisma.RecipeItemCreateNestedManyWithoutRecipeInput> = z
  .object({
    create: z
      .union([
...
export const RecipeItemCreateNestedManyWithoutRecipeInputObjectSchema = Schema;
