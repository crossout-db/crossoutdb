...
const Schema: z.ZodType<Prisma.ItemStatsUncheckedCreateWithoutReleaseInput> = z
  .object({
...
export const ItemStatsUncheckedCreateWithoutReleaseInputObjectSchema = Schema;
