...
exports.UserUpdateWithoutAccountsInputObjectSchema = void 0;
/* eslint-disable */
...
const ItemStatsUpdateManyWithoutUserNestedInput_schema_1 = require("./ItemStatsUpdateManyWithoutUserNestedInput.schema");
const LogUpdateManyWithoutUserNestedInput_schema_1 = require("./LogUpdateManyWithoutUserNestedInput.schema");
exports.UserUpdateWithoutAccountsInputObjectSchema = zod_1.z.object({
    id: zod_1.z.union([zod_1.z.string(),
        ...
        zod_1.z.lazy(() => NullableStringFieldUpdateOperationsInput_schema_1.NullableStringFieldUpdateOperationsInputObjectSchema),
        zod_1.z.null()]).optional().nullable(), sessions: zod_1.z.lazy(() => SessionUpdateManyWithoutUserNestedInput_schema_1.SessionUpdateManyWithoutUserNestedInputObjectSchema).optional(), itemStats: zod_1.z.lazy(() => ItemStatsUpdateManyWithoutUserNestedInput_schema_1.ItemStatsUpdateManyWithoutUserNestedInputObjectSchema).optional(), log: zod_1.z.lazy(() => LogUpdateManyWithoutUserNestedInput_schema_1.LogUpdateManyWithoutUserNestedInputObjectSchema).optional()
}).strict();
