...
const Schema: z.ZodType<Prisma.ItemStatsUncheckedUpdateManyWithoutItemStatsInput> =
  z
    .object({
      id: z
        .union([
...
export const ItemStatsUncheckedUpdateManyWithoutItemStatsInputObjectSchema =
  Schema;
