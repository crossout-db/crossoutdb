...
import { ItemStatsUncheckedUpdateManyWithoutUserNestedInputObjectSchema } from './ItemStatsUncheckedUpdateManyWithoutUserNestedInput.schema';
import { logUncheckedUpdateManyWithoutUserNestedInputObjectSchema } from './logUncheckedUpdateManyWithoutUserNestedInput.schema';
...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutSessionsInput> = z
  .object({
    ...
    itemStats: z
      .lazy(
        () => ItemStatsUncheckedUpdateManyWithoutUserNestedInputObjectSchema,
      )
      .optional(),
    log: z
      .lazy(() => logUncheckedUpdateManyWithoutUserNestedInputObjectSchema)
      .optional(),
  })
  .strict();
