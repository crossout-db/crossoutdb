...
exports.ItemUncheckedCreateWithoutFactionInputObjectSchema = void 0;
/* eslint-disable */
...
exports.ItemUncheckedCreateWithoutFactionInputObjectSchema = zod_1.z.object({
    id: zod_1.z.number().optional(), name: zod_1.z.string(), marketDef: zod_1.z.union([zod_1.z.string(),
        zod_1.z.null()]).optional().nullable(), quantity: zod_1.z.number(), typeId: zod_1.z.number(), categoryId: zod_1.z.number(), rarityId: zod_1.z.number(), level: zod_1.z.number(), sellPriceMin: zod_1.z.union([zod_1.z.number(),
