...
const Schema: z.ZodType<Prisma.ItemStatsUpdateManyWithWhereWithoutItemInput> = z
  .object({
...
export const ItemStatsUpdateManyWithWhereWithoutItemInputObjectSchema = Schema;
