...
exports.ItemWhereUniqueInputObjectSchema = void 0;
/* eslint-disable */
...
exports.ItemWhereUniqueInputObjectSchema = zod_1.z.object({
    id: zod_1.z.number().optional(), marketDef: zod_1.z.string().optional(), AND: zod_1.z.union([zod_1.z.lazy(() => ItemWhereInput_schema_1.ItemWhereInputObjectSchema),
        zod_1.z.lazy(() => ItemWhereInput_schema_1.ItemWhereInputObjectSchema).array()]).optional(), OR: zod_1.z.lazy(() => ItemWhereInput_schema_1.ItemWhereInputObjectSchema).array().optional(), NOT: zod_1.z.union([zod_1.z.lazy(() => ItemWhereInput_schema_1.ItemWhereInputObjectSchema),
        zod_1.z.lazy(() => ItemWhereInput_schema_1.ItemWhereInputObjectSchema).array()]).optional(), name: zod_1.z.union([zod_1.z.lazy(() => StringFilter_schema_1.StringFilterObjectSchema),
        zod_1.z.string()]).optional(), quantity: zod_1.z.union([zod_1.z.lazy(() => IntFilter_schema_1.IntFilterObjectSchema),
