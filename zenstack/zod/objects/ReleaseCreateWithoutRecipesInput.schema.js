...
exports.ReleaseCreateWithoutRecipesInputObjectSchema = void 0;
/* eslint-disable */
...
exports.ReleaseCreateWithoutRecipesInputObjectSchema = zod_1.z.object({
    name: zod_1.z.string(), xoVersion: zod_1.z.union([zod_1.z.string(),
        ...
        zod_1.z.null()]).optional().nullable(), active: zod_1.z.boolean(), itemStats: zod_1.z.lazy(() => ItemStatsCreateNestedManyWithoutReleaseInput_schema_1.ItemStatsCreateNestedManyWithoutReleaseInputObjectSchema).optional(), packs: zod_1.z.lazy(() => PackCreateNestedManyWithoutReleaseInput_schema_1.PackCreateNestedManyWithoutReleaseInputObjectSchema).optional()
}).strict();
