...
const Schema: z.ZodType<Prisma.PackUncheckedUpdateManyWithoutReleaseNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => PackUpsertWithWhereUniqueWithoutReleaseInputObjectSchema,
          ),
          z
            .lazy(
              () => PackUpsertWithWhereUniqueWithoutReleaseInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => PackUpdateWithWhereUniqueWithoutReleaseInputObjectSchema,
          ),
          z
            .lazy(
              () => PackUpdateWithWhereUniqueWithoutReleaseInputObjectSchema,
...
export const PackUncheckedUpdateManyWithoutReleaseNestedInputObjectSchema =
  Schema;
