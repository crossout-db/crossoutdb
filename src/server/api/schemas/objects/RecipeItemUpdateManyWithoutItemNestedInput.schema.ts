...
const Schema: z.ZodType<Prisma.RecipeItemUpdateManyWithoutItemNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => RecipeItemUpdateManyWithWhereWithoutItemInputObjectSchema),
        z
          .lazy(() => RecipeItemUpdateManyWithWhereWithoutItemInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const RecipeItemUpdateManyWithoutItemNestedInputObjectSchema = Schema;
