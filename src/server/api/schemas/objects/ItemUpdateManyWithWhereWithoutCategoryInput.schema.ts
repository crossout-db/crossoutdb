...
const Schema: z.ZodType<Prisma.ItemUpdateManyWithWhereWithoutCategoryInput> = z
  .object({
...
export const ItemUpdateManyWithWhereWithoutCategoryInputObjectSchema = Schema;
