...
const Schema: z.ZodType<Prisma.ItemCreateNestedManyWithoutRarityInput> = z
  .object({
    create: z
      .union([
        ...
        z.lazy(() => ItemUncheckedCreateWithoutRarityInputObjectSchema).array(),
      ])
      .optional(),
    connectOrCreate: z
      .union([
        z.lazy(() => ItemCreateOrConnectWithoutRarityInputObjectSchema),
        z.lazy(() => ItemCreateOrConnectWithoutRarityInputObjectSchema).array(),
      ])
      .optional(),
    createMany: z
...
export const ItemCreateNestedManyWithoutRarityInputObjectSchema = Schema;
