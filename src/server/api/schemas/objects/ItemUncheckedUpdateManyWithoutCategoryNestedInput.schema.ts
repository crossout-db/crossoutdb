...
const Schema: z.ZodType<Prisma.ItemUncheckedUpdateManyWithoutCategoryNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => ItemUpsertWithWhereUniqueWithoutCategoryInputObjectSchema,
          ),
          z
            .lazy(
              () => ItemUpsertWithWhereUniqueWithoutCategoryInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => ItemUpdateWithWhereUniqueWithoutCategoryInputObjectSchema,
          ),
          z
            .lazy(
              () => ItemUpdateWithWhereUniqueWithoutCategoryInputObjectSchema,
...
export const ItemUncheckedUpdateManyWithoutCategoryNestedInputObjectSchema =
  Schema;
