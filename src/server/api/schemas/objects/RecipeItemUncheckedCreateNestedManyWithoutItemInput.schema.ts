...
const Schema: z.ZodType<Prisma.RecipeItemUncheckedCreateNestedManyWithoutItemInput> =
  z
    .object({
      create: z
        .union([
...
export const RecipeItemUncheckedCreateNestedManyWithoutItemInputObjectSchema =
  Schema;
