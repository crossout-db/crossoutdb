...
const Schema: z.ZodType<Prisma.PackPriceUncheckedCreateNestedManyWithoutPackInput> =
  z
    .object({
      create: z
        .union([
...
export const PackPriceUncheckedCreateNestedManyWithoutPackInputObjectSchema =
  Schema;
