...
exports.ReleaseUncheckedCreateInputObjectSchema = void 0;
/* eslint-disable */
...
exports.ReleaseUncheckedCreateInputObjectSchema = zod_1.z.object({
    id: zod_1.z.number().optional(), name: zod_1.z.string(), xoVersion: zod_1.z.union([zod_1.z.string(),
        ...
        zod_1.z.null()]).optional().nullable(), active: zod_1.z.boolean(), itemStats: zod_1.z.lazy(() => ItemStatsUncheckedCreateNestedManyWithoutReleaseInput_schema_1.ItemStatsUncheckedCreateNestedManyWithoutReleaseInputObjectSchema).optional(), recipes: zod_1.z.lazy(() => RecipeUncheckedCreateNestedManyWithoutReleaseInput_schema_1.RecipeUncheckedCreateNestedManyWithoutReleaseInputObjectSchema).optional(), packs: zod_1.z.lazy(() => PackUncheckedCreateNestedManyWithoutReleaseInput_schema_1.PackUncheckedCreateNestedManyWithoutReleaseInputObjectSchema).optional()
}).strict();
