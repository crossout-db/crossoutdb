...
exports.ItemStatsWhereUniqueInputObjectSchema = void 0;
/* eslint-disable */
...
exports.ItemStatsWhereUniqueInputObjectSchema = zod_1.z.object({
    id: zod_1.z.number().optional(), AND: zod_1.z.union([zod_1.z.lazy(() => ItemStatsWhereInput_schema_1.ItemStatsWhereInputObjectSchema),
        zod_1.z.lazy(() => ItemStatsWhereInput_schema_1.ItemStatsWhereInputObjectSchema).array()]).optional(), OR: zod_1.z.lazy(() => ItemStatsWhereInput_schema_1.ItemStatsWhereInputObjectSchema).array().optional(), NOT: zod_1.z.union([zod_1.z.lazy(() => ItemStatsWhereInput_schema_1.ItemStatsWhereInputObjectSchema),
        zod_1.z.lazy(() => ItemStatsWhereInput_schema_1.ItemStatsWhereInputObjectSchema).array()]).optional(), itemId: zod_1.z.union([zod_1.z.lazy(() => IntFilter_schema_1.IntFilterObjectSchema),
        ...
        zod_1.z.string(),
        zod_1.z.null()]).optional().nullable(), item: zod_1.z.union([zod_1.z.lazy(() => ItemRelationFilter_schema_1.ItemRelationFilterObjectSchema),
        zod_1.z.lazy(() => ItemWhereInput_schema_1.ItemWhereInputObjectSchema)]).optional(), user: zod_1.z.union([zod_1.z.lazy(() => UserRelationFilter_schema_1.UserRelationFilterObjectSchema),
        zod_1.z.lazy(() => UserWhereInput_schema_1.UserWhereInputObjectSchema)]).optional(), release: zod_1.z.union([zod_1.z.lazy(() => ReleaseNullableRelationFilter_schema_1.ReleaseNullableRelationFilterObjectSchema),
