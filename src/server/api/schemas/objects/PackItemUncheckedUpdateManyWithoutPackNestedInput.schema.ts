...
const Schema: z.ZodType<Prisma.PackItemUncheckedUpdateManyWithoutPackNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => PackItemUpsertWithWhereUniqueWithoutPackInputObjectSchema,
          ),
          z
            .lazy(
              () => PackItemUpsertWithWhereUniqueWithoutPackInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => PackItemUpdateWithWhereUniqueWithoutPackInputObjectSchema,
          ),
          z
            .lazy(
              () => PackItemUpdateWithWhereUniqueWithoutPackInputObjectSchema,
...
export const PackItemUncheckedUpdateManyWithoutPackNestedInputObjectSchema =
  Schema;
