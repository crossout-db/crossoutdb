...
exports.ItemStatsCreateInputObjectSchema = void 0;
/* eslint-disable */
const zod_1 = require("zod");
const ItemCreateNestedOneWithoutItemStatsInput_schema_1 = require("./ItemCreateNestedOneWithoutItemStatsInput.schema");
...
exports.ItemStatsCreateInputObjectSchema = zod_1.z.object({
    timestamp: zod_1.z.union([zod_1.z.date().optional(), zod_1.z.string().datetime().optional()]), description: zod_1.z.union([zod_1.z.string(),
        ...
        zod_1.z.null()]).optional().nullable(), item: zod_1.z.lazy(() => ItemCreateNestedOneWithoutItemStatsInput_schema_1.ItemCreateNestedOneWithoutItemStatsInputObjectSchema), user: zod_1.z.lazy(() => UserCreateNestedOneWithoutItemStatsInput_schema_1.UserCreateNestedOneWithoutItemStatsInputObjectSchema), release: zod_1.z.lazy(() => ReleaseCreateNestedOneWithoutItemStatsInput_schema_1.ReleaseCreateNestedOneWithoutItemStatsInputObjectSchema).optional()
}).strict();
