...
const Schema: z.ZodType<Prisma.ItemUncheckedUpdateManyWithoutTypeNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ItemUncheckedUpdateManyWithoutTypeNestedInputObjectSchema = Schema;
