...
const Schema: z.ZodType<Prisma.PackPriceUncheckedUpdateManyWithoutPackNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => PackPriceUpdateManyWithWhereWithoutPackInputObjectSchema,
          ),
          z
            .lazy(
              () => PackPriceUpdateManyWithWhereWithoutPackInputObjectSchema,
...
export const PackPriceUncheckedUpdateManyWithoutPackNestedInputObjectSchema =
  Schema;
