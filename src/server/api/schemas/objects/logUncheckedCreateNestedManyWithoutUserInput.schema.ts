...
const Schema: z.ZodType<Prisma.logUncheckedCreateNestedManyWithoutUserInput> = z
  .object({
    create: z
      .union([
...
export const logUncheckedCreateNestedManyWithoutUserInputObjectSchema = Schema;
