import { z } from 'zod';
import { ItemCreateNestedOneWithoutItemStatsInputObjectSchema } from './ItemCreateNestedOneWithoutItemStatsInput.schema';
import { UserCreateNestedOneWithoutItemStatsInputObjectSchema } from './UserCreateNestedOneWithoutItemStatsInput.schema';
import { ReleaseCreateNestedOneWithoutItemStatsInputObjectSchema } from './ReleaseCreateNestedOneWithoutItemStatsInput.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.ItemStatsCreateInput> = z
  .object({
    ...
    item: z.lazy(() => ItemCreateNestedOneWithoutItemStatsInputObjectSchema),
    user: z.lazy(() => UserCreateNestedOneWithoutItemStatsInputObjectSchema),
    release: z
      .lazy(() => ReleaseCreateNestedOneWithoutItemStatsInputObjectSchema)
      .optional(),
  })
  .strict();

export const ItemStatsCreateInputObjectSchema = Schema;
