...
const Schema: z.ZodType<Prisma.PackItemUncheckedCreateNestedManyWithoutItemInput> =
  z
    .object({
      create: z
        .union([
...
export const PackItemUncheckedCreateNestedManyWithoutItemInputObjectSchema =
  Schema;
