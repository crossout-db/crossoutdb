...
exports.LogUpdateInputObjectSchema = void 0;
/* eslint-disable */
...
const UserUpdateOneRequiredWithoutLogNestedInput_schema_1 = require("./UserUpdateOneRequiredWithoutLogNestedInput.schema");
...
exports.LogUpdateInputObjectSchema = zod_1.z.object({
    timestamp: zod_1.z.union([zod_1.z.union([zod_1.z.date(), zod_1.z.string().datetime().optional()]),
        ...
        jsonSchema]).optional(), user: zod_1.z.lazy(() => UserUpdateOneRequiredWithoutLogNestedInput_schema_1.UserUpdateOneRequiredWithoutLogNestedInputObjectSchema).optional()
}).strict();
