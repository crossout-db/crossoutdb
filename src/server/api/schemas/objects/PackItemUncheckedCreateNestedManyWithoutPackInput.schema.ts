...
const Schema: z.ZodType<Prisma.PackItemUncheckedCreateNestedManyWithoutPackInput> =
  z
    .object({
      create: z
        .union([
...
export const PackItemUncheckedCreateNestedManyWithoutPackInputObjectSchema =
  Schema;
