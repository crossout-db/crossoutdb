...
const Schema: z.ZodType<Prisma.ItemUncheckedUpdateManyWithoutFactionNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => ItemUpsertWithWhereUniqueWithoutFactionInputObjectSchema,
          ),
          z
            .lazy(
              () => ItemUpsertWithWhereUniqueWithoutFactionInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => ItemUpdateWithWhereUniqueWithoutFactionInputObjectSchema,
          ),
          z
            .lazy(
              () => ItemUpdateWithWhereUniqueWithoutFactionInputObjectSchema,
...
export const ItemUncheckedUpdateManyWithoutFactionNestedInputObjectSchema =
  Schema;
