...
import { ItemUpdateOneRequiredWithoutItemStatsNestedInputObjectSchema } from './ItemUpdateOneRequiredWithoutItemStatsNestedInput.schema';
...
const Schema: z.ZodType<Prisma.ItemStatsUpdateWithoutReleaseInput> = z
  .object({
    timestamp: z
      .union([
        z.coerce.date(),
    ...
    perks: z
      ...
      .nullable(),
    item: z
      .lazy(() => ItemUpdateOneRequiredWithoutItemStatsNestedInputObjectSchema)
      .optional(),
    user: z
...
export const ItemStatsUpdateWithoutReleaseInputObjectSchema = Schema;
