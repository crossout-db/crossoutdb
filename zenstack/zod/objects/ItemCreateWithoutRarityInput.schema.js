...
exports.ItemCreateWithoutRarityInputObjectSchema = void 0;
/* eslint-disable */
...
const PackItemCreateNestedManyWithoutItemInput_schema_1 = require("./PackItemCreateNestedManyWithoutItemInput.schema");
const SynergyItemCreateNestedManyWithoutItemInput_schema_1 = require("./SynergyItemCreateNestedManyWithoutItemInput.schema");
exports.ItemCreateWithoutRarityInputObjectSchema = zod_1.z.object({
    name: zod_1.z.string(), marketDef: zod_1.z.union([zod_1.z.string(),
        ...
        zod_1.z.null()]).optional().nullable(), type: zod_1.z.lazy(() => TypeCreateNestedOneWithoutItemsInput_schema_1.TypeCreateNestedOneWithoutItemsInputObjectSchema), category: zod_1.z.lazy(() => CategoryCreateNestedOneWithoutItemsInput_schema_1.CategoryCreateNestedOneWithoutItemsInputObjectSchema), faction: zod_1.z.lazy(() => FactionCreateNestedOneWithoutItemsInput_schema_1.FactionCreateNestedOneWithoutItemsInputObjectSchema), itemStats: zod_1.z.lazy(() => ItemStatsCreateNestedManyWithoutItemInput_schema_1.ItemStatsCreateNestedManyWithoutItemInputObjectSchema).optional(), market: zod_1.z.lazy(() => MarketCreateNestedManyWithoutItemInput_schema_1.MarketCreateNestedManyWithoutItemInputObjectSchema).optional(), badgeExchange: zod_1.z.lazy(() => BadgeExchangeCreateNestedManyWithoutItemInput_schema_1.BadgeExchangeCreateNestedManyWithoutItemInputObjectSchema).optional(), recipes: zod_1.z.lazy(() => RecipeCreateNestedManyWithoutResultInput_schema_1.RecipeCreateNestedManyWithoutResultInputObjectSchema).optional(), recipeItems: zod_1.z.lazy(() => RecipeItemCreateNestedManyWithoutItemInput_schema_1.RecipeItemCreateNestedManyWithoutItemInputObjectSchema).optional(), packItems: zod_1.z.lazy(() => PackItemCreateNestedManyWithoutItemInput_schema_1.PackItemCreateNestedManyWithoutItemInputObjectSchema).optional(), itemSynergies: zod_1.z.lazy(() => SynergyItemCreateNestedManyWithoutItemInput_schema_1.SynergyItemCreateNestedManyWithoutItemInputObjectSchema).optional()
}).strict();
