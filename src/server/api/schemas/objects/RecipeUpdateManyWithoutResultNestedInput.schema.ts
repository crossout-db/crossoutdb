...
const Schema: z.ZodType<Prisma.RecipeUpdateManyWithoutResultNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => RecipeUpsertWithWhereUniqueWithoutResultInputObjectSchema),
        z
          .lazy(() => RecipeUpsertWithWhereUniqueWithoutResultInputObjectSchema)
          .array(),
      ])
      .optional(),
    createMany: z
    ...
    update: z
      .union([
        z.lazy(() => RecipeUpdateWithWhereUniqueWithoutResultInputObjectSchema),
        z
          .lazy(() => RecipeUpdateWithWhereUniqueWithoutResultInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const RecipeUpdateManyWithoutResultNestedInputObjectSchema = Schema;
