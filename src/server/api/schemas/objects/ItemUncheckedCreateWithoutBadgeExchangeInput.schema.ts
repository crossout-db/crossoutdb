...
const Schema: z.ZodType<Prisma.ItemUncheckedCreateWithoutBadgeExchangeInput> = z
  .object({
...
export const ItemUncheckedCreateWithoutBadgeExchangeInputObjectSchema = Schema;
