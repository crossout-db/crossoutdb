...
exports.PackCreateWithoutItemsInputObjectSchema = void 0;
/* eslint-disable */
...
exports.PackCreateWithoutItemsInputObjectSchema = zod_1.z.object({
    name: zod_1.z.string(), description: zod_1.z.union([zod_1.z.string(),
        ...
        zod_1.z.null()]).optional().nullable(), coins: zod_1.z.number(), active: zod_1.z.boolean(), release: zod_1.z.lazy(() => ReleaseCreateNestedOneWithoutPacksInput_schema_1.ReleaseCreateNestedOneWithoutPacksInputObjectSchema).optional(), packPrices: zod_1.z.lazy(() => PackPriceCreateNestedManyWithoutPackInput_schema_1.PackPriceCreateNestedManyWithoutPackInputObjectSchema).optional()
}).strict();
