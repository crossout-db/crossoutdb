...
import { SynergyItemUpdateManyWithoutItemNestedInputObjectSchema } from './SynergyItemUpdateManyWithoutItemNestedInput.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.ItemUpdateWithoutBadgeExchangeInput> = z
  .object({
    name: z
      .union([
        z.string(),
    ...
    packItems: z
      ...
      .optional(),
    itemSynergies: z
      .lazy(() => SynergyItemUpdateManyWithoutItemNestedInputObjectSchema)
      .optional(),
  })
  .strict();

export const ItemUpdateWithoutBadgeExchangeInputObjectSchema = Schema;
