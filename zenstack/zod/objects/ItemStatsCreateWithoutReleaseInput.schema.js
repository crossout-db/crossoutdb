...
exports.ItemStatsCreateWithoutReleaseInputObjectSchema = void 0;
/* eslint-disable */
...
exports.ItemStatsCreateWithoutReleaseInputObjectSchema = zod_1.z.object({
    timestamp: zod_1.z.union([zod_1.z.date().optional(), zod_1.z.string().datetime().optional()]), description: zod_1.z.union([zod_1.z.string(),
        ...
        zod_1.z.null()]).optional().nullable(), item: zod_1.z.lazy(() => ItemCreateNestedOneWithoutItemStatsInput_schema_1.ItemCreateNestedOneWithoutItemStatsInputObjectSchema), user: zod_1.z.lazy(() => UserCreateNestedOneWithoutItemStatsInput_schema_1.UserCreateNestedOneWithoutItemStatsInputObjectSchema)
}).strict();
