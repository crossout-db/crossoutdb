...
const Schema: z.ZodType<Prisma.RecipeItemUpdateManyWithoutRecipeNestedInput> = z
  .object({
    create: z
      .union([
...
export const RecipeItemUpdateManyWithoutRecipeNestedInputObjectSchema = Schema;
