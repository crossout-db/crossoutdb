...
const Schema: z.ZodType<Prisma.ItemStatsUncheckedCreateNestedManyWithoutItemInput> =
  z
    .object({
      create: z
        .union([
...
export const ItemStatsUncheckedCreateNestedManyWithoutItemInputObjectSchema =
  Schema;
