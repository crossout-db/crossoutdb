...
const Schema: z.ZodType<Prisma.ItemUncheckedUpdateWithoutBadgeExchangeInput> = z
  .object({
    id: z
      .union([
        z.number(),
...
export const ItemUncheckedUpdateWithoutBadgeExchangeInputObjectSchema = Schema;
