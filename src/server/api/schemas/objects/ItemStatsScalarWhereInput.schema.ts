...
const Schema: z.ZodType<Prisma.ItemStatsScalarWhereInput> = z
  .object({
    AND: z
      .union([
      ...
      .optional(),
    OR: z
      .lazy(() => ItemStatsScalarWhereInputObjectSchema)
      .array()
      .optional(),
    NOT: z
      .union([
...
export const ItemStatsScalarWhereInputObjectSchema = Schema;
