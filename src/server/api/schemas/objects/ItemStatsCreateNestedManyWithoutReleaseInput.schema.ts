...
const Schema: z.ZodType<Prisma.ItemStatsCreateNestedManyWithoutReleaseInput> = z
  .object({
    create: z
      .union([
...
export const ItemStatsCreateNestedManyWithoutReleaseInputObjectSchema = Schema;
