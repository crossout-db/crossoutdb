...
const Schema: z.ZodType<Prisma.ItemStatsUncheckedUpdateManyWithoutReleaseNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ItemStatsUncheckedUpdateManyWithoutReleaseNestedInputObjectSchema =
  Schema;
