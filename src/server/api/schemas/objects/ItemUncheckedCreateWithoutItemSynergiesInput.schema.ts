...
const Schema: z.ZodType<Prisma.ItemUncheckedCreateWithoutItemSynergiesInput> = z
  .object({
...
export const ItemUncheckedCreateWithoutItemSynergiesInputObjectSchema = Schema;
