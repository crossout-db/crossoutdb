...
exports.NestedJsonFilterObjectSchema = zod_1.z.object({
    equals: zod_1.z.union([jsonSchema,
        zod_1.z.lazy(() => JsonNullValueFilter_schema_1.JsonNullValueFilterSchema)]).optional(), path: zod_1.z.string().array().optional(), string_contains: zod_1.z.string().optional(), string_starts_with: zod_1.z.string().optional(), string_ends_with: zod_1.z.string().optional(), array_contains: zod_1.z.union([jsonSchema,
        zod_1.z.null()]).optional().nullable(), array_starts_with: zod_1.z.union([jsonSchema,
