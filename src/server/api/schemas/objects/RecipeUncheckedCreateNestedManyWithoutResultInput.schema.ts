...
const Schema: z.ZodType<Prisma.RecipeUncheckedCreateNestedManyWithoutResultInput> =
  z
    .object({
      create: z
        .union([
...
export const RecipeUncheckedCreateNestedManyWithoutResultInputObjectSchema =
  Schema;
