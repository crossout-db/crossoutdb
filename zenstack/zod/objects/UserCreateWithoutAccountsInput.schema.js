...
exports.UserCreateWithoutAccountsInputObjectSchema = void 0;
/* eslint-disable */
...
exports.UserCreateWithoutAccountsInputObjectSchema = zod_1.z.object({
    id: zod_1.z.string().optional(), name: zod_1.z.union([zod_1.z.string(),
        ...
        zod_1.z.null()]).optional().nullable(), sessions: zod_1.z.lazy(() => SessionCreateNestedManyWithoutUserInput_schema_1.SessionCreateNestedManyWithoutUserInputObjectSchema).optional(), itemStats: zod_1.z.lazy(() => ItemStatsCreateNestedManyWithoutUserInput_schema_1.ItemStatsCreateNestedManyWithoutUserInputObjectSchema).optional(), log: zod_1.z.lazy(() => LogCreateNestedManyWithoutUserInput_schema_1.LogCreateNestedManyWithoutUserInputObjectSchema).optional()
}).strict();
