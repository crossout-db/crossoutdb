...
const Schema: z.ZodType<Prisma.ItemUncheckedCreateNestedManyWithoutTypeInput> =
  z
    .object({
      create: z
        .union([
...
export const ItemUncheckedCreateNestedManyWithoutTypeInputObjectSchema = Schema;
