...
const Schema: z.ZodType<Prisma.ItemStatsUpdateManyWithWhereWithoutUserInput> = z
  .object({
...
export const ItemStatsUpdateManyWithWhereWithoutUserInputObjectSchema = Schema;
