...
const Schema: z.ZodType<Prisma.PackItemUpdateManyWithoutItemNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => PackItemUpsertWithWhereUniqueWithoutItemInputObjectSchema),
        z
          .lazy(() => PackItemUpsertWithWhereUniqueWithoutItemInputObjectSchema)
          .array(),
      ])
      .optional(),
    createMany: z
    ...
    update: z
      .union([
        z.lazy(() => PackItemUpdateWithWhereUniqueWithoutItemInputObjectSchema),
        z
          .lazy(() => PackItemUpdateWithWhereUniqueWithoutItemInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const PackItemUpdateManyWithoutItemNestedInputObjectSchema = Schema;
